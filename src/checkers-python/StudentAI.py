...
# Describes a state in the game. It has the current board and the current player's turn
class GameState:
    ...
    # Expand the node by filling the children with a list of all nodes with the boards
    # for all moves that result from this board
    def get_all_resulting_states(self):
        ...
        for checker_moves in moves:
            ...
            for move in checker_moves:
                ...
                child = GameState(new_board, self.opponent[self.player_number])
...
class GameStateNode:
    ...
    # Fill this states list of children with all resulting states
    def expand(self):
